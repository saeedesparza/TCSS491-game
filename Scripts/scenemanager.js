class SceneManager {
    ...
    nextLevelImmediate() {
        ...
        // Loop back to first level (tutorial) if currentLevel exceeds available levels
        if (this.currentLevel >= this.levels.length) {
            this.currentLevel = 0;
        }
        
        // Load the current level using the levels array
        this.levels[this.currentLevel].loader();
        this._queued = false;
    }
}